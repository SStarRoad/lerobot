...
def slug_task(task: str) -> str:
    mapping = {
        ...
        "抬手": "raise_hand",
        "上下抬手": "raise_arms",
        "先点头再挥手": "nod_then_wave",
        "先点头再抬手": "nod_then_raise_hand",
        "摇头": "shake_head",
        "边摇头边挥手": "shake_head_while_wave",
        "摇三次头同时抬两次手": "shake_head_3x_raise_hands_2x",
        "左手挥手": "wave_left",
        "一边抬起双手，一边点头一下": "raise_arms_while_nod_once",
        "第一步挥右手一下，第二步点头一下": "wave_right_once_then_nod_once",
        "点头三次后挥手两次": "nod_3x_then_wave_2x",
        "左手挥三次后挑眉两次": "wave_left_3x_then_eyebrow_2x",
        "左手挥一下后在最高点定住，再点两下头": "wave_left_hold_high_then_nod_2x",
        "右手挥手": "wave_right",
        "跳舞": "dance",
        "跳一段舞": "dance",
    }
